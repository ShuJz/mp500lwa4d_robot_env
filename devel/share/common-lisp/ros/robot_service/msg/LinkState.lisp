...
(cl:defmethod cl:initialize-instance :after ((m <LinkState>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'LinkState)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name robot_service-msg:<LinkState> is deprecated: use robot_service-msg:LinkState instead.")))

(cl:ensure-generic-function 'link_name-val :lambda-list '(m))
(cl:defmethod link_name-val ((m <LinkState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robot_service-msg:link_name-val is deprecated.  Use robot_service-msg:link_name instead.")
  (link_name m))
...
(cl:defmethod reference_frame-val ((m <LinkState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robot_service-msg:reference_frame-val is deprecated.  Use robot_service-msg:reference_frame instead.")
  (reference_frame m))
