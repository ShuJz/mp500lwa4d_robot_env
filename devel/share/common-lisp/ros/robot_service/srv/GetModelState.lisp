...
(cl:defmethod cl:initialize-instance :after ((m <GetModelState-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GetModelState-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name robot_service-srv:<GetModelState-request> is deprecated: use robot_service-srv:GetModelState-request instead.")))

(cl:ensure-generic-function 'model_name-val :lambda-list '(m))
(cl:defmethod model_name-val ((m <GetModelState-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robot_service-srv:model_name-val is deprecated.  Use robot_service-srv:model_name instead.")
  (model_name m))
...
(cl:defmethod relative_entity_name-val ((m <GetModelState-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robot_service-srv:relative_entity_name-val is deprecated.  Use robot_service-srv:relative_entity_name instead.")
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<GetModelState-request>)))
  ...
  "robot_service/GetModelStateRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'GetModelState-request)))
  "Returns string type for a service object of type 'GetModelState-request"
  "robot_service/GetModelStateRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <GetModelState-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GetModelState-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name robot_service-srv:<GetModelState-response> is deprecated: use robot_service-srv:GetModelState-response instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <GetModelState-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robot_service-srv:header-val is deprecated.  Use robot_service-srv:header instead.")
  (header m))

(cl:ensure-generic-function 'pose-val :lambda-list '(m))
(cl:defmethod pose-val ((m <GetModelState-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robot_service-srv:pose-val is deprecated.  Use robot_service-srv:pose instead.")
  (pose m))

(cl:ensure-generic-function 'twist-val :lambda-list '(m))
(cl:defmethod twist-val ((m <GetModelState-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robot_service-srv:twist-val is deprecated.  Use robot_service-srv:twist instead.")
  (twist m))

(cl:ensure-generic-function 'success-val :lambda-list '(m))
(cl:defmethod success-val ((m <GetModelState-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robot_service-srv:success-val is deprecated.  Use robot_service-srv:success instead.")
  (success m))

(cl:ensure-generic-function 'status_message-val :lambda-list '(m))
(cl:defmethod status_message-val ((m <GetModelState-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robot_service-srv:status_message-val is deprecated.  Use robot_service-srv:status_message instead.")
  (status_message m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<GetModelState-response>)))
  ...
  "robot_service/GetModelStateResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'GetModelState-response)))
  "Returns string type for a service object of type 'GetModelState-response"
  "robot_service/GetModelStateResponse")
