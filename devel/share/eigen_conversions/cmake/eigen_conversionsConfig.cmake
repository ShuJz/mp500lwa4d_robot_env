...
if("TRUE" STREQUAL "TRUE")
  set(eigen_conversions_SOURCE_PREFIX /home/jingzhe/WorkSpace/ROS/mp500lwa4d_robot_env/src/geometry/eigen_conversions)
  set(eigen_conversions_DEVEL_PREFIX /home/jingzhe/WorkSpace/ROS/mp500lwa4d_robot_env/devel)
  ...
  set(eigen_conversions_INSTALL_PREFIX /home/jingzhe/WorkSpace/ROS/mp500lwa4d_robot_env/install)
...
if(NOT "/home/jingzhe/WorkSpace/ROS/mp500lwa4d_robot_env/src/geometry/eigen_conversions/include;/usr/include/eigen3;/opt/ros/kinetic/include " STREQUAL " ")
  set(eigen_conversions_INCLUDE_DIRS "")
  set(_include_dirs "/home/jingzhe/WorkSpace/ROS/mp500lwa4d_robot_env/src/geometry/eigen_conversions/include;/usr/include/eigen3;/opt/ros/kinetic/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'eigen_conversions' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/jingzhe/WorkSpace/ROS/mp500lwa4d_robot_env/src/geometry/eigen_conversions/${idir}'.  ${_report}")
    endif()
    _list_append_unique(eigen_conversions_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "eigen_conversions;/opt/ros/kinetic/lib/liborocos-kdl.so.1.3.0")
