...
"""autogenerated by genpy from robot_service/Pose.msg. Do not edit."""
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
import struct

import robot_service.msg

class Pose(genpy.Message):
  _md5sum = "e45d45a5a1ce597b249e23fb30fc871f"
  _type = "robot_service/Pose"
...
"""
  ...
  _slot_types = ['robot_service/Point','robot_service/Quaternion']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.position is None:
        self.position = robot_service.msg.Point()
      if self.orientation is None:
        self.orientation = robot_service.msg.Quaternion()
    else:
      self.position = robot_service.msg.Point()
      self.orientation = robot_service.msg.Quaternion()
